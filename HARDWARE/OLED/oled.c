...
{      			    
    ...
    {   
		...
		else if(size==16)temp=chinese[num][t];	//调用1608字体
...
void OLED_ShowIntegerNumber(u8 x,u8 y,int num,u8 size)
{
	...
	else
	{
		...
		if(size==16)
			...
			OLED_ShowNum(x+6,y,num,len,size);
	}
}
...
{ 	 				 	 					    
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出B C   VVV        
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出 初始化PB12 PB13
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	GPIO_SetBits(GPIOB, GPIO_Pin_12|GPIO_Pin_13);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出 初始化PC8
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOC, &GPIO_InitStructure);
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出 初始化PA5 PA7
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
